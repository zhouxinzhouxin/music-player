...
/***/ function(module, exports, __webpack_require__) {
	...
	var controlManager = function () {
	    ...
	    function renderInfo(info) {
	        var html = '<h1 class="song-name">' + info.song + '</h1>' + '<h3 class="singer-name">演唱：' + info.singer + '</h3>' + '<h3 class="album-name">专辑：' + info.album + '</h3>' + '<h3 class="rhythm"> 作曲：' + info.rhythm + '</h3>' + '<h3 class="lyric">作词：' + info.lyric + '</h3>';
